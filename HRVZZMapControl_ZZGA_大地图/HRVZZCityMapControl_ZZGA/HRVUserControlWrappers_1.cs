...
namespace HighResolutionApps.VisualControls.HRVZZCityMapControl_ZZGA
{
    ...
    public class HRVUserControlPropProxy : HighResolutionApps.Common.Schema.BasePropProxy
    {
        ...
        public override PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            ...
            RegisterProperty(typeof(HRVZZCityMapControl_ZZGA), "HighNum", null, result, "定义地图中颜色范围的数据中”数量高”的最大值", "数据");
            RegisterProperty(typeof(HRVZZCityMapControl_ZZGA), "LowNum", null, result, "定义地图中颜色范围的数据中”数量中等”的最小值", "数据");
